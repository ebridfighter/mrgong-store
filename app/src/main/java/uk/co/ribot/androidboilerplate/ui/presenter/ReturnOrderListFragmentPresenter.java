 ...
 */
public class ReturnOrderListFragmentPresenter extends BasePresenter<ReturnOrderListMvpView> {
    ...
    @Inject
    public ReturnOrderListFragmentPresenter(DataManager dataManager) {
